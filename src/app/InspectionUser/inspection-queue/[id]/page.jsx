              ...
              <section className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 sm:p-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                  ...
                  <div>
                    ...
                    <div className="text-gray-900 font-medium text-sm sm:text-base">Titanium alloy</div>
                  </div>
                  <div>
                  ...
                  <div className="sm:col-span-2">
                    ...
                    <div className="text-gray-900 font-medium text-sm sm:text-base">10880 Malibu Point, 90265</div>
                  </div>
                </div>
              </section>
            ...
            <div className="space-y-4 sm:space-y-6">
              ...
              <section className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 sm:p-6">
                ...
                <div className="space-y-1 sm:space-y-2">
                  {['Inspection Report','Quality Check','Test Results','Defect Analysis','Final Approval'].map((r, i) => (
